...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--code_dir", type=str, default="/path/to/revealmar")
    parser.add_argument("--data_root", type=str, default="/path/to/imagenet")
    parser.add_argument("--pretrain_root", type=str, default="/path/to/pretrained_models")

    parser.add_argument(
        "--planmar_ckpt",
        type=str,
        default="/path/to/output/planmar_checkpoint",
        help="Checkpoint directory for PlanMAR-S, containing checkpoint-last.pth.",
    )
    parser.add_argument(
        "--baseline_ckpt",
        type=str,
        default="/path/to/pretrained_models/mar/mar_base",
        help=(
    ...
    parser.add_argument("--eval_root", type=str, default="/path/to/output/planmar_eval")
