...
From the RevealMAR repo root:
  ...
  python .\collect_reveal_trajectory_results.py --trajectory_root "<repo_root>\p0_runs\reveal_trajectory" --intervention_root "<repo_root>\p0_runs\early_step_intervention"
...
Trajectory outputs:
  ...
  <repo_root>\p0_runs\reveal_trajectory

Intervention outputs:

  <repo_root>\p0_runs\early_step_intervention
