...
REM ============================================================
REM P0-1 Main Results Table runner for Windows CMD.
...
set TABLE_NAME=main
set TABLE_DIR=%OUTPUT_ROOT%\main_results
...
call :RUN_VARIANT "PlanMAR-S Fixed Budget" "PlanMAR-S" "planner" "fixed" "%PLANMAR_RESUME%" "planner" "mixed_reveal" "hard"
call :RUN_VARIANT "PlanMAR-S Score-derived Budget" "PlanMAR-S" "planner" "score-derived" "%PLANMAR_RESUME%" "planner" "mixed_reveal" "soft"
